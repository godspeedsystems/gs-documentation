...
### Enable OTel
[Enable OTel](../cli/godspeed-cli.md/#otel) in your service using [Godspeed CLI](../cli/godspeed-cli.md) by setting `OTEL_ENABLED` to true. You can alternatively set it in the `.env` file of your service.
```
