...
2. Check/Uncheck `Enable MCP Servers`
  ...
  ![Enable MCP Servers toggle](/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-2.png)
...
2. Press the `Delete` button on the confirmation box
  ...
  ![Delete confirmation box](/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-5.png)
...
![Network Timeout pulldown](/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-6.png)
