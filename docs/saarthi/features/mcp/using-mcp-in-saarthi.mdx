...
An MCP (Model Context Protocol) server acts as a bridge, giving Saarthi access to a wider range of **tools** and external services like databases, APIs, or custom scripts. It uses a standard communication method, allowing Roo to leverage these external capabilities.
...
1. Click the <Codicon name="server" /> icon in the top navigation of the Saarthi pane.
  ...
  <img src="/img/using-mcp-in-saarthi/using-mcp-in-saarthi-10.png" alt="MCP Servers interface in Saarthi" width="400" />
...
3. Click the appropriate button:
  ...
  <img src="/img/using-mcp-in-saarthi/using-mcp-in-saarthi-9.png" alt="Edit Global MCP and Edit Project MCP buttons" width="600" />
...
* **Ask Roo:** You can ask Saarthi to help you find or even create MCP servers (when "[Enable MCP Server Creation](#enabling-or-disabling-mcp-server-creation)" is enabled)
