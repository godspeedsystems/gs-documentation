...
1. Click the <Codicon name="server" /> icon in the top navigation of the Saarthi pane.
  ...
  <img src="/static/img/using-mcp-in-saarthi/using-mcp-in-saarthi-10.png" alt="MCP Servers interface in Saarthi" width="400" />
...
3. Click the appropriate button:
  ...
  <img src="/static/img/using-mcp-in-saarthi/using-mcp-in-saarthi-9.png" alt="Edit Global MCP and Edit Project MCP buttons" width="600" />
...
2. Check/Uncheck `Enable MCP Servers`
  ...
  <img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-2.png" alt="Enable MCP Servers toggle" width="400" />
...
2. Check/Uncheck `Enable MCP Server Creation`
  ...
  <img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-3.png" alt="Enable MCP Server Creation toggle" width="400" />
...
## Managing Individual MCP Servers
   ...
   <img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-8.png" alt="Example of a configuration pane for a MCP Server" width="400" />
...
2. Locate the MCP server you want to manage in the list
   <img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-4.png" alt="List of MCP Servers" width="400" />
...
2. Press the `Delete` button on the confirmation box
  ...
  <img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-5.png" alt="Delete confirmation box" width="400" />
...
<img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-6.png" alt="Network Timeout pulldown" width="400" />
...
<img src="/static/img/using-mcp-in-Saarthi/using-mcp-in-Saarthi-7.png" alt="Always allow checkbox for MCP tools" width="120" />
