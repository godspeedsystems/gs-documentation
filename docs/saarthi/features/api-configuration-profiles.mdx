...
2. Click the "+" button next to the profile selector
   ...
   <img src="/static/img/api-configuration-profiles/api-configuration-profiles-1.png" alt="Profile selector with plus button" width="550" />
3. Enter a name for your new profile
   
   <img src="/static/img/api-configuration-profiles/api-configuration-profiles.png" alt="Creating a new profile dialog" width="550" />
4. Configure the profile settings:
   - Select your API provider
      
      <img src="/static/img/api-configuration-profiles/api-configuration-profiles-2.png" alt="Provider selection dropdown" width="550" />
   - Enter API key
   
      <img src="/static/img/api-configuration-profiles/api-configuration-profiles-3.png" alt="API key entry field" width="550" />
   - Choose a model
   
      <img src="/static/img/api-configuration-profiles/api-configuration-profiles-8.png" alt="Model selection interface" width="550" />
   - Configure the **Rate Limit** for this profile:
     ...
     - Requests using other profiles follow their own rate limits.
         ...
         <img src="/static/img/api-configuration-profiles/api-configuration-profiles-12.png" alt="Rate limit slider control within API profile settings" width="550" />
...
1. From Settings panel: Select a different profile from the dropdown
   ...
   <img src="/static/img/api-configuration-profiles/api-configuration-profiles-7.png" alt="Profile selection dropdown in Settings" width="550" />
2. During chat: Access the API Configuration dropdown in the chat interface

   <img src="/static/img/api-configuration-profiles/api-configuration-profiles-6.png" alt="API Configuration dropdown in chat interface" width="550" />
...
<img src="/static/img/api-configuration-profiles/api-configuration-profiles-4.png" alt="Pinning API configuration profiles" width="550" />
...
<img src="/static/img/api-configuration-profiles/api-configuration-profiles-10.png" alt="Profile editing interface" width="550" />
...
<img src="/static/img/api-configuration-profiles/api-configuration-profiles-11.png" alt="Profile-Mode association interface in Prompts tab" width="550" />
