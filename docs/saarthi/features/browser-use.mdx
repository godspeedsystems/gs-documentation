...
<img src="/static/img/browser-use/browser-use-1.png" alt="Browser use example" width="300" />
...
1. Open Settings by clicking the gear icon <Codicon name="gear" /> → Browser / Computer Use
   ...
   <img src="/static/img/browser-use/browser-use.png" alt="Browser settings menu" width="600" />
...
1. Check or uncheck the "Enable browser tool" checkbox within your Browser / Computer Use settings
   ...
   <img src="/static/img/browser-use/browser-use-2.png" alt="Enable browser tool setting" width="300" />
...
2. Select your desired resolution.
   ...
   <img src="/static/img/browser-use/browser-use-3.png" alt="Viewport size setting" width="600" />
...
3. Higher values provide clearer screenshots but increase token usage:
   ...
   <img src="/static/img/browser-use/browser-use-4.png" alt="Screenshot quality setting" width="600" />
...
2. Click "Test Connection" to verify
   ...
   <img src="/static/img/browser-use/browser-use-5.png" alt="Remote browser connection setting" width="600" />
